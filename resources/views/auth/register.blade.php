<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{role: ''}">
            @csrf
            ...
            <div class="mt-4" x-show="role == 'student'">
                <x-jet-label for="matric_no" value="{{ __('Matriculation number') }}" />
                <x-jet-input id="matric_no" class="block mt-1 w-full" type="text"  name="matric_no" />
            </div>
